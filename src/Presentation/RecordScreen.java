...
public class RecordScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtTreatments = new javax.swing.JTextField();
        txtPrescription = new javax.swing.JTextField();
        txtMstudies = new javax.swing.JTextField();
        txtVaccines = new javax.swing.JTextField();
        ...
        jLabel1.setText("Buscar por # Registro");
        ...
        getContentPane().add(cmbPetId, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 170, 250, -1));
        ...
        getContentPane().add(txtDiagnostic, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 210, 250, -1));
        getContentPane().add(txtTreatments, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 250, 250, -1));
        getContentPane().add(txtPrescription, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 330, 250, -1));
        getContentPane().add(txtMstudies, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 290, 250, -1));
        getContentPane().add(txtVaccines, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 370, 250, -1));
        ...
        getContentPane().add(btnCreate, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 440, -1, -1));
        ...
        getContentPane().add(btnRead, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 130, -1, -1));
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 440, -1, -1));

        jLabel9.setFont(new java.awt.Font("Yu Gothic UI Semibold", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 102, 102));
        jLabel9.setText("Gestionar Registro");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, -1, -1));
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 130, 160, -1));

        txtDisplayConsecutive.setEditable(false);
        txtDisplayConsecutive.setFocusable(false);
        getContentPane().add(txtDisplayConsecutive, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 130, 100, -1));
    ...
    private void getFormInfo() {
        ...
        //String refId = txtDisplayConsecutive.getText();
        String petID = (String) cmbPetId.getSelectedItem();
        String diagnostic = txtDiagnostic.getText();
        String treatment = txtTreatments.getText();
        String medicalStudies = txtMstudies.getText();
        String prescription = txtPrescription.getText();
        String vaccines = txtVaccines.getText();

        Record.CreateNewRecord(recid, petID, diagnostic, treatment, medicalStudies, prescription, vaccines);

        CleanUpForm();

    }

    private void readArecord() {
        String getRefId = txtSearch.getText();
        String[] petData = Record.readRecord(getRefId);
        if (petData != null) {
            String refId = petData[0];
            String petId = petData[1];
            String diagnostic = petData[2];
            String treatment = petData[3];
            String mStudies = petData[4];
            String prescription = petData[5];
            String vaccines = petData[6];

            txtDisplayConsecutive.setText(refId);
            cmbPetId.setSelectedItem(petId);
            txtDiagnostic.setText(diagnostic);
            txtTreatments.setText(treatment);
            txtMstudies.setText(mStudies);
            txtPrescription.setText(prescription);
            txtVaccines.setText(vaccines);
    ...
    public void updateArecord() {
        ...
        //New record
        Record record = new Record(recid, petID, diagnostic, treatment, medicalStudies, prescription, vaccines);

        // Update the record file
        boolean success = record.updateRecord();

        if (success) {
            JOptionPane.showMessageDialog(null, "Registro " + recid + " actualizado", "Éxito", JOptionPane.INFORMATION_MESSAGE);
            CleanUpForm();
        } else {
    ...
    public void deleteArecord() {
        String recid = txtDisplayConsecutive.getText();
        Record.deleteRecord(recid);
        CleanUpForm();
    }

    public void CleanUpForm() {
        txtDisplayConsecutive.setText("");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecordScreen().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtMstudies;
    private javax.swing.JTextField txtPrescription;
    private javax.swing.JTextField txtSearch;
    private javax.swing.JTextField txtTreatments;
    private javax.swing.JTextField txtVaccines;
